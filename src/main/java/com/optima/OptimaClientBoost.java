 ...
 */
public final class OptimaClientBoost {

    private static boolean applied;
    private static boolean failed;

    private OptimaClientBoost() {
    }
    ...
    public static void apply() {
        ...
        try {
            ...
            failed = true;
            Optima.LOGGER.error("[Optima] Graphics boost skipped - Minecraft classes unavailable. "
    ...
    private static void applyInner() {
        ...
        if (mc == null || mc.options == null) {
            Optima.LOGGER.warn("[Optima] Options not ready yet, graphics boost skipped this session.");
            failed = true;
            return;
        }
            ...
            try {
                ...
                for (String wanted : constantNames) {
                    ...
                    if (tryInvoke(holder, "set", target) != null) {
                        Optima.LOGGER.info("[Optima]   {} -> {}", fieldName, wanted);
                        return 1;
                    }
                }
            } catch (Throwable t) {
                Optima.LOGGER.debug("[Optima] Could not set {}: {}", fieldName, t);
            }
        }
        Optima.LOGGER.warn("[Optima] Could not resolve option {} - skipped. "
    ...
    private static int setBoolean(Object options, String[] fieldNames, boolean value) {
            ...
            try {
                ...
                if (current instanceof Boolean) {
                    ...
                    if (tryInvoke(holder, "set", value) != null) {
                        Optima.LOGGER.info("[Optima]   {} -> {}", fieldName, value);
                        return 1;
                    }
                }
            } catch (Throwable t) {
        ...
        Optima.LOGGER.warn("[Optima] Could not resolve option {} - skipped.", fieldNames[0]);
        return 0;
    }
