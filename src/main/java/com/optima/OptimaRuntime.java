 ...
 */
public final class OptimaRuntime {

    /** Mirrored into {@link OptimaFast#collectStats}; off unless diagnostics are enabled. */
    ...
    public static void onBlockEntityCulled() {
        ...
        if (!beCullSeen) {
            beCullSeen = true;
            Optima.LOGGER.info("[Optima] Optimization ACTIVE: render.block_entity_distance");
        }
    }
    ...
    public static void onEntityCulled() {
        ...
        if (!entityCullSeen) {
            entityCullSeen = true;
            Optima.LOGGER.info("[Optima] Optimization ACTIVE: render.entity_distance");
        }
    }
    ...
    public static void onItemCulled() {
        ...
        if (!itemCullSeen) {
            itemCullSeen = true;
            Optima.LOGGER.info("[Optima] Optimization ACTIVE: render.item_distance");
        }
    }
    ...
    public static void onParticleSuppressed() {
        ...
        if (!particleSeen) {
            particleSeen = true;
            Optima.LOGGER.info("[Optima] Optimization ACTIVE: render.particle_budget");
        }
    }
    ...
    public static void onGoalSelectorSkipped() {
        ...
        if (!goalSeen) {
            goalSeen = true;
            Optima.LOGGER.info("[Optima] Optimization ACTIVE: tick.goal_selector");
        }
    }
    ...
    public static void onMobAiThrottled() {
        ...
        if (!throttleSeen) {
            throttleSeen = true;
            Optima.LOGGER.info("[Optima] Optimization ACTIVE: tick.mob_ai_throttle");
        }
    }
